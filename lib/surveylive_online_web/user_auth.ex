defmodule SurveyliveOnlineWeb.UserAuth do
  @moduledoc """
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_surveylive_online_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      SurveyliveOnlineWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule SurveyliveOnlineWeb.PageLive do
        ...
        on_mount {SurveyliveOnlineWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SurveyliveOnlineWeb.UserAuth, :ensure_authenticated}] do
