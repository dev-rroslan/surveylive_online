defmodule SurveyliveOnlineWeb.Admin.SessionController do
  use SurveyliveOnlineWeb, :controller

  import SurveyliveOnline.Admins.GenerateAdmin
  alias SurveyliveOnline.Admins
  alias SurveyliveOnline.Admins.Guardian

  plug SurveyliveOnlineWeb.Plugs.RedirectAdmin when action in [:new, :create]
