defmodule SurveyliveOnline.Accounts.Invitation do
  @moduledoc """
  ...
  schema "invitations" do
    ...
    belongs_to :invited_by, SurveyliveOnline.Users.User, foreign_key: :invited_by_user_id
    belongs_to :account, SurveyliveOnline.Accounts.Account
