defmodule SurveyliveOnline.Accounts do
  @moduledoc """
  ...
  alias SurveyliveOnline.Accounts.Account
  alias SurveyliveOnline.Accounts.Membership
  alias SurveyliveOnline.Accounts.Member
  alias SurveyliveOnline.Accounts.Invitation

  def paginate_accounts(params \\ %{}) do
    SurveyliveOnline.Pagination.paginate_records(Account, params)
  end
  ...
  use Phoenix.VerifiedRoutes, endpoint: SurveyliveOnlineWeb.Endpoint, router: SurveyliveOnlineWeb.Router
  alias SurveyliveOnline.Mailer
  alias SurveyliveOnline.Accounts.InvitationNotifier
