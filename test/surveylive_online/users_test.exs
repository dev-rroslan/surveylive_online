defmodule SurveyliveOnline.UsersTest do
  use SurveyliveOnline.DataCase

  alias SurveyliveOnline.Users

  import SurveyliveOnline.UsersFixtures
  alias SurveyliveOnline.Users.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "creates the personal account" do
      ...
      assert %SurveyliveOnline.Accounts.Account{personal: true} = user.personal_account
      assert [%SurveyliveOnline.Accounts.Membership{role: :owner}] = user.memberships
    end
  end
