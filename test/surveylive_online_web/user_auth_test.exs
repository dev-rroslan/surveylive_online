defmodule SurveyliveOnlineWeb.UserAuthTest do
  use SurveyliveOnlineWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias SurveyliveOnline.Users
  alias SurveyliveOnlineWeb.UserAuth
  import SurveyliveOnline.UsersFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SurveyliveOnlineWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SurveyliveOnlineWeb.Endpoint.subscribe(live_socket_id)
